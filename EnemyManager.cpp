...
void EnemyManager::Reset()
{
	...
	for (int i = 0; i < vecGolbats.size(); i++)
	{
		...
		vecGolbats[i]->SetAsh(ash);
		vecGolbats[i]->Reset(-100, -100);
	}
	   
	vecFireBirds[0]->Reset(-100, -100);
	vecHoOhs[0]->Reset(-100, -100);
	vecLugias[0]->Reset(-100, -100);
