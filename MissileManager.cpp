...
HRESULT BulbasaurMissileManager::Init()
{
	for (auto& it : vecMissiles)
	{
		it->Init();
...
HRESULT DarkpetMissileManager::Init()
{
	for (auto& it : vecMissiles)
	{
		it->Init();
...
HRESULT SlowpokeMissileManager::Init()
{
	for (auto& it : vecMissiles)
	{
		it->Init();
...
HRESULT LugiaMissileManager::Init()
{
	for (auto& it : vecMissiles)
	{
		it->Init();
...
HRESULT HoohMissileManager::Init()
{
	for (auto& it : vecMissiles)
	{
		it->Init();
...
HRESULT FireBirdMissileManager::Init()
{
	for (auto& it : vecMissiles)
	{
		it->Init();
...
HRESULT PhantomMissileManager::Init()
{
	for (auto& it : vecMissiles)
	{
		it->Init();
